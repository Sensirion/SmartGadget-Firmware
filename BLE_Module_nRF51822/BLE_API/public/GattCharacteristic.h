...
public:
    ...
    */
    ...
    GattCharacteristic(const UUID    &uuid,
                       ...
                       uint8_t *      userDescription     = 0,
                       uint16_t       userDescriptionMaxLen      = 0,
                       uint16_t       userDescriptionMinLen      = 0) :
        _valueAttribute(uuid, valuePtr, initialLen, maxLen),
        _properties(props),
        _descriptors(descriptors),
        _descriptorCount(numDescriptors),
        _userDescription(userDescription),
        _userDescriptionMaxLen(userDescriptionMaxLen),
        _userDescriptionMinLen(userDescriptionMinLen),
...
public:
    ...
    uint8_t*                getUserDescription(void)      const {return _userDescription;               }
    uint16_t                getUserDescriptionMaxLen(void) const {return _userDescriptionMaxLen;        }
    uint16_t                getUserDescriptionMinLen(void) const {return _userDescriptionMinLen;        }
...
private:
    ...
    uint8_t *       _userDescription;
    uint16_t        _userDescriptionMaxLen;
    uint16_t        _userDescriptionMinLen;
