                                     ...
                                     uint16_t char_user_desc_size)
{
    ...
    char_md.p_char_user_desc = p_char_user_desc;
    char_md.char_user_desc_max_size = char_user_desc_max_size;
...
error_t status = (error_t)sd_ble_gatts_descriptor_add(char_handle,
                                                &attr_desc,
                                                p_desc_handle);
