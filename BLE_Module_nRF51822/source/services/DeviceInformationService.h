...
public:
  ...
  DeviceInformationService(BLEDevice& _ble,
    ...
    ble(_ble),
    systemIdStringCharacteristic(GattCharacteristic::UUID_SYSTEM_ID_CHAR,
                                 const_cast<uint8_t *>(systemId),
                                 8, /* minLength */
                                 8, /* maxLength */
                                         ...
                                         GattCharacteristic::BLE_GATT_CHAR_PROPERTIES_READ)
  {
    ...
    GattCharacteristic* charTable[] = {&systemIdStringCharacteristic,
...
private:
  BLEDevice& ble;
  GattCharacteristic systemIdStringCharacteristic;
